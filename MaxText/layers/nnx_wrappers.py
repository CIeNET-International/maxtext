...
def to_linen_class(
  ...
  for name, (annotation, default) in constructor_fields.items():
    ...
    if default is dataclasses.MISSING:
      dataclass_fields.append((name, annotation))  # pylint: disable=invalid-field-call
    else:
      dataclass_fields.append((name, annotation, dataclasses.field(default=default)))  # pylint: disable=invalid-field-calls
