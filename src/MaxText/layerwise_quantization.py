...
from MaxText.utils.quantization_utils import get_abstract_state_nnx
from MaxText.utils.quantization_utils import load_weights_into_deepseek_layer
from MaxText.utils.quantization_utils import validate_loaded_params
from MaxText.utils.quantization_utils import validate_post_load
...
def main(argv: Sequence[str]) -> None:
  ...
  rngs = nnx.Rngs(jax.random.PRNGKey(1234))
  quantization = LayerwiseQuantization(config, rngs)
