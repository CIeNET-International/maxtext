...
"""Pipeline V19: Save dots_with_no_batch_dims alongside named residuals for XLA scheduling freedom."""
...
class NNXPipelineBase(nnx.Module):
  ...
  def get_pipeline_remat_policy(self):
    ...
    save_input_policy = jax.checkpoint_policies.save_from_both_policies(
        jax.checkpoint_policies.dots_with_no_batch_dims_saveable,
        jax.checkpoint_policies.save_only_these_names("iteration_input", "decoder_layer_input")
    )
