...
# --- pipeline_logged: per-method instrumentation -----------------------------
# Always-on: `jax.named_scope` wraps each method body so HLO / XProf attribute
# memory and time to the named scope (cheap, no runtime overhead in compiled
# code beyond the scope annotation).
#
# Opt-in via env vars:
#   MAXTEXT_PIPELINE_LOG=1       -> jax.debug.print "enter"/"exit" per method
#   MAXTEXT_PIPELINE_MEMSTATS=1  -> jax.debug.callback that prints live TPU
#                                   memory_stats at each method boundary
# ----------------------------------------------------------------------------
_PIPELINE_LOG = _os.environ.get("MAXTEXT_PIPELINE_LOG", "0") == "1"
_PIPELINE_MEMSTATS = _os.environ.get("MAXTEXT_PIPELINE_MEMSTATS", "0") == "1"


def _pipeline_log_memory(label):
  """Host callback: prints live device memory_stats. TPU has memory_stats;
  CPU/GPU may not — wrapped in try/except."""
  ...
  def _cb():
    try:
      ...
      print(f"[PL MEM] {label}: used={used:.2f}GB peak={peak:.2f}GB", flush=True)
    except Exception as e:  # pylint: disable=broad-except
      print(f"[PL MEM] {label}: err {e}", flush=True)

  jax.debug.callback(_cb, ordered=True)


def _logged_method(name):
  """Decorator: wrap method body in jax.named_scope, plus optional prints."""

  def _deco(fn):
    @functools.wraps(fn)
    def _wrapped(*args, **kwargs):
      if _PIPELINE_LOG:
        jax.debug.print("[PL] {n} enter", n=name)
      if _PIPELINE_MEMSTATS:
        _pipeline_log_memory(f"{name} enter")
      with jax.named_scope(name):
        result = fn(*args, **kwargs)
      if _PIPELINE_LOG:
        jax.debug.print("[PL] {n} exit", n=name)
      if _PIPELINE_MEMSTATS:
        _pipeline_log_memory(f"{name} exit")
      return result
...
class NNXPipelineBase(nnx.Module):
  ...
  @_logged_method("NNXPipelineBase._setup_pipeline_attributes")
  ...
  @_logged_method("NNXPipelineBase.need_circ_storage")
  ...
  @_logged_method("NNXPipelineBase.iterations_to_complete_first_microbatch_one_repeat")
  ...
  @_logged_method("NNXPipelineBase.iterations_to_complete_first_microbatch")
  ...
  @_logged_method("NNXPipelineBase._maybe_shard_with_logical")
  ...
  @_logged_method("NNXPipelineBase._maybe_shard_with_name")
  ...
  @_logged_method("NNXPipelineBase.get_iteration_inputs")
  ...
  @_logged_method("NNXPipelineBase.get_microbatch_and_repeat_ids")
  ...
  @_logged_method("NNXPipelineBase.get_pipeline_remat_policy")
  ...
  @staticmethod
  @_logged_method("NNXPipelineBase._remove_fsdp_from_physical_partition_spec")
  ...
  @_logged_method("NNXPipelineBase.init_states")
  ...
  @_logged_method("NNXPipelineBase.shard_dim_by_stages")
  ...
  @_logged_method("NNXPipelineBase.vmap_parallel_gather")
  ...
  @_logged_method("NNXPipelineBase.vmap_gather")
  ...
  @_logged_method("NNXPipelineBase.get_new_loop_state")
  ...
  @_logged_method("NNXPipelineBase.permute_output_micro_per_stage_dim")
  ...
  @_logged_method("NNXPipelineBase.realign_output_microbatches")
  ...
  @_logged_method("NNXPipelineBase.get_weight_sharding")
  ...
  @_logged_method("NNXPipelineBase.get_main_vmap_func_for_iterations")
  ...
  @staticmethod
  @_logged_method("NNXPipelineBase._stamp_at_current_trace")
  ...
  @_logged_method("NNXPipelineBase.get_current_stage_weights")
  ...
  @_logged_method("NNXPipelineBase.all_gather_over_fsdp")
  ...
  @_logged_method("NNXPipelineBase.get_logical_spec_repeats_removed")
...
class NNXPipeline(NNXPipelineBase):
  ...
  @_logged_method("NNXPipeline.get_current_stage_weights")
  def get_current_stage_weights(self, pipeline_weights, loop_iteration, physical_partition_spec=None):
    if self.config.num_pipeline_repeats > 1:
      return self.get_current_repeat_from_stages(
          pipeline_weights, loop_iteration, physical_partition_spec=physical_partition_spec
  ...
  @_logged_method("NNXPipeline.get_current_repeat_from_stages")
  ...
  @_logged_method("NNXPipeline.run_one_iteration")
  ...
  @_logged_method("NNXPipeline.__call__")
  def __call__(
      self,
      inputs: jnp.ndarray,
...
class NNXCircularPipeline(NNXPipelineBase):
  ...
  @_logged_method("NNXCircularPipeline.get_main_vmap_func_for_iterations")
  def get_main_vmap_func_for_iterations(self):
  ...
  @_logged_method("NNXCircularPipeline.gather_microbatch_inputs_vmap")
  ...
  @_logged_method("NNXCircularPipeline.gather_weights_across_stages_vmap")
  ...
  @_logged_method("NNXCircularPipeline.from_all_variables_to_repeat_weights")
  ...
  @_logged_method("NNXCircularPipeline.from_repeat_weights_to_bsw")
  ...
  @_logged_method("NNXCircularPipeline.weight_prefetching")
  ...
  @_logged_method("NNXCircularPipeline.fetch_active_stage_weights")
  ...
  @_logged_method("NNXCircularPipeline.get_current_weights_from_bsw")
  ...
  @_logged_method("NNXCircularPipeline.run_one_iteration")
  def run_one_iteration(
      self,
      loop_state,
      bsw,
  ...
  @_logged_method("NNXCircularPipeline.__call__")
  def __call__(
      self,
      inputs: jnp.ndarray,
      segment_ids: jnp.ndarray,
