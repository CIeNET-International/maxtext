...
"""V65i-F: V65i-A with unroll=2 on outer scan.

Pairs of iterations share w_curr via Python intermediate, halving carry storage.
Expected: ~25 GB memory + ~114 tok/s throughput.
"""
